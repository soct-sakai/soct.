...
export function PricingTablePopup() {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="w-[95vw] max-w-6xl h-[95vh] max-h-[95vh] p-2 md:p-6">
        <DialogHeader className="pb-2">
          <DialogTitle className="text-lg md:text-2xl font-bold text-center">セットメニュー価格早見表</DialogTitle>
        </DialogHeader>

        <div className="flex-1 overflow-y-auto space-y-3 md:space-y-4 px-1">
          <p className="text-xs md:text-sm text-gray-600 text-center">
            各テレビサイズとオプションの組み合わせによる総合価格をご確認いただけます
          </p>

          <div className="relative w-full bg-white rounded-lg shadow-sm border overflow-x-auto">
          ...
          <div className="block md:hidden text-center">
            <p className="text-xs text-blue-600 bg-blue-50 px-3 py-2 rounded-full inline-block">
              👆 表を左右にスワイプして全体をご確認ください
            </p>
          </div>

          <div className="bg-blue-50 p-3 md:p-4 rounded-lg">
            <h3 className="font-semibold mb-2 text-sm md:text-base">価格表の見方</h3>
          ...
          <div className="bg-orange-50 p-3 md:p-4 rounded-lg">
            <h3 className="font-semibold mb-2 text-orange-800 text-sm md:text-base">ご注意</h3>
            <ul className="text-xs md:text-sm space-y-1 text-orange-700">
