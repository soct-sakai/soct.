        ...
        <Card className="overflow-hidden">
          <CardContent className="p-8">
            ...
            <div className={`space-y-4 ${isExpanded ? "" : "max-h-48 overflow-hidden"}`}>
              ...
              <p>わざわざうちのホームページまで来てくれて、本当にありがとうございます！</p>
              <p>正直に言って、俺の人生、これまでの会社社長とはちょっと違うかもしれません。</p>
              <p>だって、16歳の時に高校を途中でやめちまったんですから。</p>
              <p>そこから、がむしゃらに、色んな仕事をしてきました。</p>

              <p>17歳で、まだガキだったのに、新築の家を建てたり、古い家を直したりする職人に。</p>
              ...
              <p>
                29歳で結婚して、30歳からは一人で軽貨物の運送業を始めたんです。雨の日も風の日も、荷物を届けて、自分の力で飯を食う厳しさを知りました。
              </p>
              <p>
                そして39歳、ついに「株式会社速人」を立ち上げました。最初っから、軽貨物と便利屋。何でも屋の始まりです。
              </p>

              <p>43歳で、俺に待望の娘が生まれました。</p>
              <p>
              ...
              <p>
                正直、これまで「なんで俺ってこうなんだろう」「なんでこんなに不器用なんだろう」って悩むことばかりだった。
              </p>
              <p>
                でも、その時思ったんです。<strong>「あ、これが俺なんだ」「ここからが本当の俺の人生なんだ」</strong>
                って。
              </p>
              <p>この経験が、俺の人生を本当に変えてくれました。</p>
              <p>今、俺が壁掛けテレビの事業に本気で取り組んでるのは、これまでの経験全部が活きてるからなんです。</p>

              <p>
                お客さんの気持ちに寄り添って、柔らかく、丁寧に話す接客は、漫画喫茶やゲームショップで死ぬほど鍛えられました。
              </p>
              <p>
              ...
              <p>
                こんな、ちょっと不器用だけど、誰よりも家族を愛して、ゲームが大好きで、そして人一倍、お客さんの「困った」を何とかしたいって思ってる俺だからこそ、できることがあると信じてます。
              </p>
              <p>だからもし、</p>
              ...
              <p>「こんなのあったら最高！」っていう空間を、ぜひ俺と一緒に、泥臭く、真剣に考えていきませんか？</p>
